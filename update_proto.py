...
def generate_proto():
    ...
    proto_url = f"https://raw.githubusercontent.com/camunda/camunda/refs/tags/{zeebe_proto_version}/gateway-protocol/src/main/proto/gateway.proto"
