...
class TaskStatusSetter:
    def __init__(self, context: JobContext, zeebe_adapter: ZeebeAdapter):
        self.zeebe_client = zeebe_adapter
    ...
    def failure(self, message: str) -> None:
        self.zeebe_client.fail_job(job_key=self.context.key, message=message)

    def error(self, code: str, message: str):
        self.zeebe_client.throw_error(job_key=self.context.key, message=message)
