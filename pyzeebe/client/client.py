...
class ZeebeClient(object):
    ...
    def run_process(self, bpmn_process_id: str, variables: Dict = None, version: int = -1) -> int:
        ...
        Raises:
            ProcessNotFound: No process with bpmn_process_id exists
            InvalidJSON: variables is not JSONable
            ProcessHasNoStartEvent: The specified process does not have a start event
    ...
    def cancel_process_instance(self, process_instance_key: int) -> int:
        ...
        Raises:
            ProcessInstanceNotFound: If no process instance with process_instance_key exists
            ZeebeBackPressure: If Zeebe is currently in back pressure (too many requests)
            ZeebeGatewayUnavailable: If the Zeebe gateway is unavailable
            ZeebeInternalError: If Zeebe experiences an internal error
    ...
    def deploy_process(self, *process_file_path: str) -> None:
        ...
        Raises:
            ProcessInvalid: If one of the process file definitions is invalid
            ZeebeBackPressure: If Zeebe is currently in back pressure (too many requests)
            ZeebeGatewayUnavailable: If the Zeebe gateway is unavailable
            ZeebeInternalError: If Zeebe experiences an internal error
