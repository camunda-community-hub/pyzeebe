...
_CANCELWORKFLOWINSTANCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name="workflowInstanceKey", full_name="gateway_protocol.CancelWorkflowInstanceRequest.workflowInstanceKey",
      index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
...
_CREATEWORKFLOWINSTANCERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name="workflowInstanceKey", full_name="gateway_protocol.CreateWorkflowInstanceResponse.workflowInstanceKey",
      index=3,
...
_CREATEWORKFLOWINSTANCEWITHRESULTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name="requestTimeout", full_name="gateway_protocol.CreateWorkflowInstanceWithResultRequest.requestTimeout",
      index=1,
      ...
      serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name="fetchVariables", full_name="gateway_protocol.CreateWorkflowInstanceWithResultRequest.fetchVariables",
      index=2,
...
_CREATEWORKFLOWINSTANCEWITHRESULTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name="bpmnProcessId", full_name="gateway_protocol.CreateWorkflowInstanceWithResultResponse.bpmnProcessId",
      index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode("utf-8"),
      message_type=None, enum_type=None, containing_type=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      full_name="gateway_protocol.CreateWorkflowInstanceWithResultResponse.workflowInstanceKey", index=3,
      number=4, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
CancelWorkflowInstanceRequest = _reflection.GeneratedProtocolMessageType("CancelWorkflowInstanceRequest",
                                                                         (_message.Message,), {
...
CancelWorkflowInstanceResponse = _reflection.GeneratedProtocolMessageType("CancelWorkflowInstanceResponse",
                                                                          (_message.Message,), {
...
CreateWorkflowInstanceRequest = _reflection.GeneratedProtocolMessageType("CreateWorkflowInstanceRequest",
                                                                         (_message.Message,), {
...
CreateWorkflowInstanceResponse = _reflection.GeneratedProtocolMessageType("CreateWorkflowInstanceResponse",
                                                                          (_message.Message,), {
...
CreateWorkflowInstanceWithResultRequest = _reflection.GeneratedProtocolMessageType(
  "CreateWorkflowInstanceWithResultRequest", (_message.Message,), {
...
CreateWorkflowInstanceWithResultResponse = _reflection.GeneratedProtocolMessageType(
  "CreateWorkflowInstanceWithResultResponse", (_message.Message,), {
