...
@pytest.fixture
def job_executor(task: Task, queue: asyncio.Queue, task_state: TaskState, job_controller: JobController):
    return JobExecutor(task, queue, task_state, job_controller)
