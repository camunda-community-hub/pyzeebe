...
class TestBuildJobHandler:
    ...
    @pytest.mark.asyncio
    async def test_parameters_are_provided_to_task(self, task_config: TaskConfig, mocked_job_controller: JobController):
        original_task_function = AsyncMock()
